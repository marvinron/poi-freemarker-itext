...
import com.poi.bean.InnerTableListBean;
import com.poi.bean.MainInfoBean;
import com.poi.util.Office2PDFUtil;
...
public class PoiTest {
	public static void main(String[] args) throws Exception {
		...
		String fileName = wordUrl.substring(wordUrl.lastIndexOf("/")+1, wordUrl.lastIndexOf("."))+".doc";
